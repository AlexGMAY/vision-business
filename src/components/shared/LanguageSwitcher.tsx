...
//         code: 'fr' as const, 
//         name: 'Français', 
//         icon: <ReactCountryFlag countryCode="FR" svg className="w-2 h-2 rounded shadow-sm" />,
//     },
//     { 
//         code: 'en' as const, 
//         name: 'English', 
//         icon: <ReactCountryFlag countryCode="US" svg className="w-2 h-2 rounded shadow-sm" />,
//     }
//   ]
...
//       >
//         <span className="text-2xl filter drop-shadow-sm">{currentLanguage?.icon}</span>
...
//                 }`}
//               >
//                 <span className="text-2xl transition-transform duration-200 group-hover:scale-110 filter drop-shadow-sm">
//                   {language.icon}
//                 </span>
